...
class shopYpromosPluginBackendPromogiftsAction extends waViewAction
{
    const PER_PAGE = 20;
    ...
    protected function buildTemplateComposition()
    {
        ...
        return [
            'promogifts' => $this->container->make('shop', 'shopYpromosPluginPromogiftModel')->getPromogifts($boundaries['offset'], $boundaries['limit'])
        ];
    }

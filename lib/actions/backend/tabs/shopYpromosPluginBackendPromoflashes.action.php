...
class shopYpromosPluginBackendPromoflashesAction extends waViewAction
{
    const PER_PAGE = 20;
    ...
    protected function buildTemplateComposition()
    {
        ...
        return [
            'promoflashes' => $this->container->make('shop', 'shopYpromosPluginPromoflashModel')->getPromoflashes($boundaries['offset'], $boundaries['limit'])
        ];
    }

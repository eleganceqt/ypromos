...
class shopYpromosPluginPromonplusmFetchFilledModalController extends waJsonController
{
    /**
     * @var array
     */
    ...
    {
        return $this->container->make('shop', 'shopYpromosPluginPromonplusmFilledModalAction')->renderWith($vars);
    }
    ...
    {
        return [
            'promonplusm' => $this->getPromonplusm($this->inputs['promoId']),
        ];
    }
     ...
     * @return array
     */
    protected function getPromonplusm($promoId)
    {
        return $this->container->make('shop', 'shopYpromosPluginPromonplusmModel')->getPromonplusm($promoId);
    }

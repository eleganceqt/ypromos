...
class shopYpromosPluginSettingsAction extends waViewAction
{
    /**
     * @var waContainer
     */
    ...
    {
        return [
            'ymProfiles' => $this->getYMarketProfiles()
        ];
    }

    /**
     * Get yandex market export profiles.
     *
     * @return array
     */
    protected function getYMarketProfiles()
    {
        return $this->container->makeWith('shop', 'shopImportexportHelper', ['yandexmarket'])->getList();
    }

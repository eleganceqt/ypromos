...
class shopYpromosPluginPromocodeFetchBlankModalController extends waJsonController
{
    /**
     * @var array
     */
    ...
    protected function fetchModal()
    {
        ...
        return $this->container->make('shop', 'shopYpromosPluginPromocodeBlankModalAction')->renderWith($vars);
    }
    ...
    {
        return [
            'coupons' => shopYpromosPluginPromocodeSupporter::getAvailableCoupons()
        ];
    }

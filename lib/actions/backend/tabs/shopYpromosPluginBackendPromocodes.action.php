...
class shopYpromosPluginBackendPromocodesAction extends waViewAction
{
    const PER_PAGE = 20;
    ...
    protected function buildTemplateComposition()
    {
        ...
        return [
            'promocodes' => $this->container->make('shop', 'shopYpromosPluginPromocodeModel')->getPromocodes($boundaries['offset'], $boundaries['limit'])
        ];
    }

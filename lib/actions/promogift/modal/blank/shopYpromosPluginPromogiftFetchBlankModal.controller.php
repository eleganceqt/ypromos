...
class shopYpromosPluginPromogiftFetchBlankModalController extends waJsonController
{
    /**
     * @var array
     */
    ...
    {
        return $this->container->make('shop', 'shopYpromosPluginPromogiftBlankModalAction')->render();
    }

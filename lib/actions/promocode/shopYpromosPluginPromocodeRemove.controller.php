...
class shopYpromosPluginPromocodeRemoveController extends waJsonController
{
    /**
     * @var array
     */
    ...
    protected function removePromo($promoId)
    {
        ...
        $this->container->make('shop', 'shopYpromosPluginPromocodeModel')->deleteByField('promo_id', $promoId);

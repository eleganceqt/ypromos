...
class shopYpromosPluginPromoflashFetchBlankModalController extends waJsonController
{
    /**
     * @var array
     */
    ...
    {
        return $this->container->make('shop', 'shopYpromosPluginPromoflashBlankModalAction')->render();
    }
